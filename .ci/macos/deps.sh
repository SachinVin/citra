...
brew install cmake p7zip ccache ffmpeg llvm ninja || true
...
wget https://homebrew.bintray.com/bottles/sdl2-2.0.14_1.arm64_big_sur.bottle.tar.gz
tar -xzf sdl2-2.0.14_1.arm64_big_sur.bottle.tar.gz
